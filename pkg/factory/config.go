...
type Configuration struct {
	...
	Nodes    []Nodes `yaml:"nodes" valid:"optional"`
	Links    []Links `yaml:"links" valid:"optional"`
}
...
type Nodes struct {
	...
	SwitchId   int    `yaml:"switchId" valid:"required"`
	PortNumIn  int    `yaml:"portNumIn" valid:"required"`
	PortNumOut int    `yaml:"portNumOut" valid:"required"`
}
